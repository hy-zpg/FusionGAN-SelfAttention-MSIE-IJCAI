...
class VGGFaceDAGANDataset(DAGANDataset):
    ...
    def load_dataset(self, gan_training_index):
        # self.x = np.load("./TestVggfaceFlowersAnimalsnpy/dataset/vggfaces_1.npy")
        self.x = np.load("./TestVggfaceFlowersAnimalsnpy/dataset/vggfaces3shot_3.npy")
        self.x = self.x / 255
...
class animalsDAGANDataset(DAGANDataset):
    ...
    def load_dataset(self, gan_training_index):
        # self.x = np.load("../Augmentednpy/dataset/animals_1027.npy")
        # self.x = np.load("./TestVggfaceFlowersAnimalsnpy/dataset/animals_1.npy")
        self.x = np.load("./TestVggfaceFlowersAnimalsnpy/dataset/animals3shot_3.npy")
        print('data shape', np.shape(self.x))
        self.x = self.x / 255
        x_train, x_val, x_test = self.x[:], self.x[:], self.x[:]
        return x_train, x_test, x_val
...
class flowersDAGANDataset(DAGANDataset):
    ...
    def load_dataset(self, gan_training_index):
        ...
        # self.x = np.load("./TestVggfaceFlowersAnimalsnpy/dataset/flowers_1.npy")
        self.x = np.load("./TestVggfaceFlowersAnimalsnpy/dataset/flowers3shot_3.npy")
        print('data shape', np.shape(self.x))
        self.x = self.x / 255
        x_train, x_val, x_test = self.x[:], self.x[:], self.x[:]
        return x_train, x_test, x_val
