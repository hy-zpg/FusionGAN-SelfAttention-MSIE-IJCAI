...
class VGGFaceDAGANDataset(DAGANDataset):
    ...
    def load_dataset(self, gan_training_index):
        ...
        # self.x = np.load("../Matching-DAGAN-1wayKshot/datasets/test_vggface_c58_s128_data.npy")
        # self.x = self.x / 255
...
class animalsDAGANDataset(DAGANDataset):
    ...
    def load_dataset(self, gan_training_index):
        ...
        # self.x = np.load("../Matching-DAGAN-1wayKshot/datasets/test_animals_c68_s128_data.npy")
        # self.x = self.x / 255
        # x_train, x_val, x_test = self.x[:], self.x[:], self.x[:]
        # print('data shape', np.shape(self.x))
...
class flowersDAGANDataset(DAGANDataset):
    ...
    def load_dataset(self, gan_training_index):
        # self.x = np.load("../Matching-DAGAN-1wayKshot/datasets/test_flowers_c65_s128_data.npy")
        # self.x = self.x / 255
        # x_train, x_val, x_test = self.x[:], self.x[:], self.x[:]
        # print('data shape', np.shape(self.x))
