                ...
                for e in range(self.classification_total_epoch):
                    ...
                    with tqdm.tqdm(total=self.total_test_batches) as pbar_samp:
                        ...
                        for iter in range(int(self.total_test_batches)):
                            if self.pretrain > 0:
                                x_test_classification_i, x_train_classification_i, y_test, y_train, _, _  = self.data.get_train_batch()
                            else:
                                x_test_classification_i, x_train_classification_i, y_test, y_train, _, _,  = self.data.get_test_batch()
                        ...
                        iter_out = "{},total_test_loss: {}, total_test_accuracy: {} ".format(iter, total_test_loss_mean,
